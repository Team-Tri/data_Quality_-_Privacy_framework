...
def get_dataframe(model,column_name):
  prompt_=f"You are Data privacy Steward ,You have to help me tag below given Columns With \
                        ...
                        response would be used in automation,strict instruction for response dont send anything else than csv format (dont truncate any data ,need all values),no explanation or notes needed    \
